...
<script>
  ...
  ga('send', 'pageview');
    ...
    <body>
        ...
        <div id="pagecontent" >
            <div style="border-left:10px solid #606060; padding-left:15px">
                <h1>Privacy Policy</h1>
                <br/>
                <span class="subhead">The Oldham Group Privacy Statement</span>
                <p>
                    THE OLDHAM GROUP (collectively referred to in this Privacy Statement as "we" or "OLDHAM") recognize the importance of protecting the privacy of all information provided by users of our web sites, subscribers to our magazines, registrants for our events, recipients of our e-mail newsletters and all of our customers. We created this policy with a fundamental respect for our users' right to privacy and to guide our relationships with our users. This privacy statement discloses the privacy practices for all products and services owned by THE OLDHAM GROUP.
                </p>
                <br/>
                <span class="subhead">Information Collection and Use</span>
                <p>
                    THE OLDHAM GROUP collects information from our website users and customers. In this section of our privacy policy, we will describe the type of information we collect and how we use it to provide better services to our customers.
                </p>
                <br/>
                <span class="subhead"> Registration and Ordering</span><br>
                <p>
                    When attending our trade shows, using some of our websites and signing up for certain selected events, users must first register. During registration, users are required to give their contact information (such as name, e-mail address, mailing address and phone number). We also may collect demographic information (such as job title and purchasing responsibilities, company information and professional certification). For internal purposes, we use this information to communicate with users and provide requested services, and, for our website visitors, to provide a more personalized experience on our sites. We use aggregate demographic information about our audience to improve our service, for marketing purposes and/or industry reporting purposes.
                </p>
                <br/>
                <p>
                ...
                <br/>
                <span class="subhead"> E-mail Newsletters</span><br>
                <p>
                ...
                <br/>
                <span class="subhead"> Surveys and Contests</span><br>
                <p>
                ...
                <br/>
                <span class="subhead"> Interactive Features</span><br>
                <p>
                ...
                <br/>
                <span class="subhead"> Communications with Us</span><br>
                <p>
                ...
                <br/>
                <span class="subhead"> Communications from Us: Service Updates, Special Offers</span><br>
                <p>
                ...
                <br/>
                <span class="subhead">Automatic Data Collection</span><br>
                <p>
                ...
                <br/>
                <span class="subhead">With Whom Your Inofrmation Is Shared</span><br>
                <p>
                ...
                <br/>
                <span class="subhead">Correction/Updating Personal Information</span><br>
                <p>
                ...
                <br/>
                <span class="subhead">Links</span><br>
                <p>
                    Our web sites contain links to other sites. THE OLDHAM GROUP is not responsible for the privacy practices or content of such other sites. We encourage our users to be aware when they leave our site and to read the privacy statements of each web site to which we may link that may collect personally identifiable information.
                </p>
                <br/>
                <span class="subhead"> Notification and Changes</span><br>
                <p>
                ...
                <p>
                    ...
                    217-528-4649 <br>
                    <a href="mailto:privacy@oldhamgroup.com">
                        privacy@oldhamgroup.com
                    </a>
                </p>
            </div>
        </div>
